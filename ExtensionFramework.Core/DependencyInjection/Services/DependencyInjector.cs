...
using ExtensionFramework.Core.Common.Exceptions;
...
using LazyDependencyInjectorOptions = ExtensionFramework.Core.DependencyInjection.Models.LazyDependencyInjectorOptions;

namespace ExtensionFramework.Core.DependencyInjection.Services;
